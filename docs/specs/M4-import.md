...
- **The copy's audio is held to its source's rate too** (`copyAudioBitRate`): 96 kbit/s a channel, or the highest of AAC's own rates at or under the source's audio rate where that is known and lower, 32 kbit/s a channel at the least. A 129 kbit/s stereo track was asked for 192 and is now asked for 128; the fixture's 100 kbit/s of stereo noise comes out at 88 where it came out at 170.
