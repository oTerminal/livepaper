...
| [0003](0003-the-user-selects-livepaper-once-and-quit-holds-a-still.md) | How the live wallpaper gets selected, and how the previous wallpaper is restored. *Proposed: changes a roadmap decision* |
