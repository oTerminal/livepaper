...
A record that is not settled yet says so in a bold **Status** line under its title; a record without one is decided.
...
| [0003](0003-the-user-selects-livepaper-once-and-quit-holds-a-still.md) | How the live wallpaper gets selected, and what stopping does: the system wallpaper stays "Livepaper" and the extension holds a still |
